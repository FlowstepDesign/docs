...
description: "Connect Flowstep to your AI editor and run your first tool call."
...
<Tabs>
  ...
  <Tab title="Claude Code">
    **Requires Claude Code CLI**
    ...
    Claude Code calls `create-file`, then `ai-prompt`, then `get-screen-image`. You'll see the rendered design inline in the chat.
  </Tab>
</Tabs>

## Next steps

- [Tools reference](/mcp/tools) — full input/output docs for all 16 tools
