...
description: "Use Flowstep to generate one screen or up to 6 screens at once from a single text prompt — ideal for fast UI ideation and exploring full flows."
---
